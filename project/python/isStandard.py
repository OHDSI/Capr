...
concept_table['concept_id'] = concept_table['concept_id'].apply(
...
for table_name in tables:
    ...
    # Clean concept_id values
    table['concept_id'] = table['concept_id'].apply(
        lambda x: x.strip().lower())
    ...
    # Save the result
    print('writing standard concept check file for ' + table_name + 'to ' + save_path + table_name)
    res.to_csv(save_path + table_name, index=False)
