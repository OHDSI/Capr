...
- **Phenotype archetypes reduce boilerplate.** The package exports `chronicOutcomeCohort()`,
  `firstEverDiagnosisCohort()`, `acuteOutcomeCohort()`, `newUserDrugCohort()`, `allDrugCohort()`,
  ...
  wrapper function. See `CAPR_REFERENCE.md` section *Phenotype Archetypes* for the full catalog and
