...
#' Read in a circe json file into R

#' @param jsonPath The path to the json file containing a circe cohort definition
#' @return A Capr Cohort definition object
#' @include LowLevelBuildLangFn.R
#' @importFrom jsonlite read_json
#' @importFrom purrr map
#' @importFrom magrittr %>%
...
jsonPath <- here::here("inst/extdata/AcCovidDiag.json")

readCohort <- function(jsonPath){


  cohort <- jsonlite::read_json(jsonPath)
